...
function LookupFunc {
    ...
    $system = "System.dll"
    $assem = ([AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.GlobalAssemblyCache -And $_.Location.Split('\\')[-1].Equals($system)}).GetType('Microsoft.Win32.UnsafeNativeMethods')
